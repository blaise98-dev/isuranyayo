...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['sucatdescription'])) {
        ...
        $query = mysqli_query($con, "update tblsubcategory set CategoryId='$categoryid',Subcategory='$subcatname',SubCatDescription='$subcatdescription', UpdationDate='$date' where SubCategoryId='$subcatid'");
        if ($query) {
...
<head>
    ...
    <title>ISURA NYAYO | Edit Sub Category</title>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control"
                                                        value="<?php echo htmlentities($row['subcatname']); ?>"
