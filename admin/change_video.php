...
$imgfile=$_FILES["postvideo"]["name"];
// get the video extension
$videoextension = substr($videofile,strlen($videofile)-4,strlen($videofile));
// allowed extensions
$video_allowed_extensions = array(".mp4","mp3",".mkv",".mov");
// Validation for allowed extensions .in_array() function searches an array for a specific value.
if(!in_array($videoextension,$video_allowed_extensions))
{
echo "<script>alert('Invalid format. Only mp4 / mkv/ mp3 /mov format allowed');</script>";
}
else
{
//rename the video file
$videonewfile=md5($videofile).$videoextension;
// Code for move video into directory
...
<img src="postimages/<?php echo htmlentities($row['postvideo']);?>" width="300"/>
<br />
...
<input type="file" class="form-control" id="postimage" name="postvideoge"  required>
</div>
</div>
</div>

<button type="submit" name="updatevideo" class="btn btn-success waves-effect waves-light">Update </button>
</form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
