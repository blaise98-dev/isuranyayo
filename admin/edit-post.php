...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $postdetails = mysqli_escape_string($con, $_POST['postdescription']);
...
<head>
    ...
    <!-- App title -->
    <title>ISURA NYAYO | Add Post</title>
...
<body class="fixed-left">
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <?php
                        $postid = intval($_GET['pid']);
                        $query = mysqli_query($con, "select tblposts.id as postid,tblposts.PostImage,tblposts.PostVideo,tblposts.PostTitle as title,tblposts.PostDetails,tblcategory.CategoryName as category,tblcategory.id as catid,tblsubcategory.SubCategoryId as subcatid,tblsubcategory.Subcategory as subcategory from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.id='$postid' and tblposts.Is_Active=1 ");
                                ...
                                <div class="">
                                    <form name="addpost" method="post">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <textarea class="summernote" name="postdescription"
                                                        required><?php echo $row['PostDetails']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="button" id="preview-button"
                                            ...
                                            data-target="#exampleModalLong"><i class="mdi mdi-eye"></i>Preview</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Preview Post</h5>
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <?php
                            ...
                            ?>
                        <img style="width:100%; height: 300px;" src="./postimages/<?php echo $row['PostImage']; ?>"
                            id="content-featured-image">
                        <br><br>
                        <i>Posted by Admin | <b><?php echo $row['PostingDate']; ?></b> Category:
                            <b><a href="#" id="content-category"></a></b>
                        </i><br><br>
                        <h2><b id="content-title"></b>
                        </h2>
                        <hr>
    ...
    jQuery(document).ready(function() {
        ...
        $('#preview-button').click(function() {
            $("#content-title").text($("#posttitle").val());
            $("#content-category").text($("#category").find(":selected").text());
            $("#content-details").html($(".summernote").summernote("code"));
        ...
        function readURL(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    $('#content-featured-image').attr('src', e.target.result);
                }
