                        ...
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb p-0 m-0">
                                    ...
                                    <li>
                                        <a href="edit-post.php?pid=<?php echo $_GET['pid']; ?>"> Edit Posts </a>
                                    </li>
                                    <li class="active">
                                        Video
                                    </li>
                                    ...
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        <h4 class="m-b-30 m-t-0 header-title"><b>Current Post Video</b>
                                                        </h4>
                                                        <video
                                                            src="postvideo/<?php echo htmlentities($row['PostVideo']); ?>"
                                                            width="300" controls>
                                                        </video><br />
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        <h4 class="m-b-30 m-t-0 header-title"><b>New Feature Video</b>
                                                        </h4>
                                            ...
                                            <button type="submit" name="updatevideo"
